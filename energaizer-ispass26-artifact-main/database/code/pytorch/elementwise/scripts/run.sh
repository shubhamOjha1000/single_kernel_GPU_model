...
mkdir -p "./data/raw"
python3 generate_bash_script_elementwise.py --profile_nvml --nvml_save_path data/raw --workload_csv_path workloads/elementwise_workload.csv --bash_save_path data/run_data_collection.sh --profile_ncu --ncu_save_path data/raw --ncu_bin_path $NCU_BIN --python_bin_path $PYTHON_BIN --cuda_device $CUDA_DEVICE --lock_gpu_clock --gpu_clock_freq 900 --sudo_password $SUDO_PWD
...
python3 generate_lut.py --result_folder data/parsed --save_to data/elementwise_database_freq900.csv